...
public class SendMailText_Picture_Enclosure {
	...
	// 发件人地址
	public static String senderAddress = "xxxxx@163.com";
	// 收件人地址
	public static String recipientAddress = "xxxxx@sina.com";
	// 发件人账户名
	public static String senderAccount = "xxxx";
	// 发件人账户密码
	public static String senderPassword = "jr5,w@";
	...
	public static MimeMessage getMimeMessage(Session session) throws Exception {
		...
		// 读取本地文件
		// DataHandler dh = new DataHandler(new FileDataSource("\\src\\zsyh.jpg"));
		DataHandler dh = new DataHandler(new FileDataSource("D:\\atoolws\\src\\zsyh.jpg"));
		...
		text.setContent("这是一张图片<br/><a href='http://www.baidu.com/'><img src='cid:mailTestPic'/></a>",
